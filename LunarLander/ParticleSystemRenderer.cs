...
namespace CS5410
{
    public class ParticleSystemRenderer
    {
        ...
        public void Draw(SpriteBatch spriteBatch, ParticleSystem system, Vector2 offset)
        {
            ...
            {
                r.X = (int)particle.center.X + (int)offset.X;
                r.Y = (int)particle.center.Y + (int)offset.Y;
